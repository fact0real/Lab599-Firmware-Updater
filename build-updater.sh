...
if [ "${1:-}" = "--test" ]; then
    ...
    clang -O2 -Wall -Wextra -Wno-unused-parameter -Werror -fobjc-arc \
        ...
        -IHeaders -ISources \
        tests/DriverAndDocsTests.m Sources/Lab599DriverController.m Sources/Lab599DocsController.m -o build/DriverAndDocsTests
